package com.c1ph3rj.simplelogin.BubblePageIndicatorPkg;
...
import com.c1ph3rj.simplelogin.R;
...
public class BubblePageIndicator extends MotionIndicator {
    ...
    public void setViewPager(@NonNull ViewPager2 view) {
        if (viewPager != null) {
    ...
    public ViewPager2.OnPageChangeCallback pageChangeCallback = new ViewPager2.OnPageChangeCallback() {
        @Override
